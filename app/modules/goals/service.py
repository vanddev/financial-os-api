...
class GoalService:
    ...
    def list(self, page: int = 1, page_size: int = 20, completed: bool | None = None, sort: str = "id", order: str = "asc"):
        skip = (page - 1) * page_size
        items, total = self.repo.list(skip=skip, limit=page_size, completed=completed, sort=sort, order=order)
        return items, total
